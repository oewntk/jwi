...
public interface ICachingDictionary extends IDictionary
{
    ...
    interface IItemCache extends IHasLifecycle
    {
         ...
         *
         * @param isEnabled if <code>true</code>, caching is enabled; if
         ...
         *
         * @param word the word to be cached; may not be <code>null</code>
         ...
         *
         * @param entry the entry to be cached; may not be <code>null</code>
         * @throws NullPointerException if the specified entry is <code>null</code>
         * @since JWI 2.2.0
         */
