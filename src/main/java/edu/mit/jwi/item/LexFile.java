...
public class LexFile implements ILexFile
{
    ...
    public static final LexFile VERB_POSSESSION = new LexFile(40, "verb.possession", "verbs of buying, selling, owning", POS.VERB);
     ...
     * @param name the name of the lexical file, may not be <code>null</code>,
     ...
     *             <code>null</code>
     * @throws NullPointerException     if either the name or description are <code>null</code>
